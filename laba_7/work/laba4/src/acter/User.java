...
public class User implements UserDo {
    ...
    public void setCardsByList(List<Card> cardsList)
    {
        for(Card ff:cardsList){
            this.cards.add(ff);
        }
    }
    public void setCreateCard(Card card){this.cards.add(card);}
    ...
    public int getCountOfMyCard(){return cards.size();}
